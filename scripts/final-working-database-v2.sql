-- FINAL WORKING DATABASE SETUP - Version 2
-- This script ensures all tables are created with proper foreign key constraints
-- and in the correct order to avoid "relation does not exist" errors.
...
CREATE TABLE group_invitations (
  id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
  group_id UUID NOT NULL REFERENCES groups(id) ON DELETE CASCADE, -- Added FK back
