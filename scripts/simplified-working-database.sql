-- SIMPLIFIED WORKING DATABASE SETUP
-- Removes foreign key constraints to avoid PostgREST relationship issues
-- This approach is more reliable and avoids schema cache problems
...
-- Create tables WITHOUT foreign key constraints to avoid PostgREST issues
...
CREATE TABLE expenses (
  ...
  paid_by_name TEXT NOT NULL, -- Store name directly to avoid joins
...
-- 6. Group invitations table (simplified)
